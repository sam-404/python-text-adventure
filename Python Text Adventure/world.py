...
class EnemyTile(MapTile):
    def __init__(self, x, y):
        ...
        if r < 0.50:
            ...
            self.dead_text =  "The corpse of d dead spider rots on the ground."
        elif r < 0.80:
            ...
            self.alive_text = """
                                You hear a squeaking noise getting louder
                                .....
            ...
            self.dead_text = "Defeated, the monster has turned into an ordinary rock."
...
class TraderTile(MapTile):
    ...
    def trade(self, buyer, seller):
        ...
        while True:
            ...
            if user_input is ['Q', 'q']:
                return
            else:
                try:
                    chouce = int(user_input)
    ...
    def check_if_trade(self, player):
        while True:
            ...
            if user_input in ['q', 'Q']:
                ...
                self.trade(buyer=self.trader, seller=palyer)
            else:
                print("Invalid choice!")

    def intro_text(self):
         return """
         A lone humonoid creature sits
         in the corner
...
class FindGoldTile(MapTile):
    ...
    def intro_text(self):
        if self.gold_claimed:
            ...
            return """
            Someone dropeed some gold. You pick it up.
            """
...
#world_map = [
#        [StartTile(0,0),VictoryTile(1,0),BoringTile(2,0)],
#        [BoringTile(0,1),EnemyTile(1,1),BoringTile(2,1)],
#        [EnemyTile(0,2),BoringTile(1,2),EnemyTile(2,2)],
#        [BoringTile(0,3),EnemyTile(1,3),BoringTile(2,3)]
#    ]
